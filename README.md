...
4. Arduino側に設定用 vendor-defined HID report を追加する
5. ファームウェアを8キー前提のスキャン処理へ変更する
6. 2本の仮想GND `OUTPUT LOW` と8本のDirect `INPUT_PULLUP` を前提に押下状態を読む
7. 外付けRGB LED / OLED 関連処理を削除し、本体LED表示へ整理する
