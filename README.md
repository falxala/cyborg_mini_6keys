...
- Key 5 boot read-only drive with local Remapper files
...
Key 5を押しながらUSB接続すると、Read-only driveをその起動だけ表示します。通常は非表示です。ドライブにはREADME、オンラインURL shortcut、ローカルRemapper HTML/JS/CSSを含めます。
